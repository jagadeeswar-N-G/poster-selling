...
export const NikeReceiptEmail = ({ firstName }: any) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={message}>
          ...
          <Heading style={global.heading}>Hello, {firstName}</Heading>
          <Text style={global.text}>
            Thank you so much for creating you accout in the poster selling app,
            this is an welocome email
          </Text>
        ...
        <Section style={paddingY}>
          <Text style={global.heading}>Posters selling</Text>
